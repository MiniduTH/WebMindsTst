    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex justify-between flex-col py-14 gap-14 lg:gap-20 min-[1124px]:flex-row">
            <div class="block  xl:max-w-lg">
                ...
                <p class="text-lg text-gray-500 mb-12 text-center min-[1124px]:text-left">Trusted in more than 100 countries & 5 million customers. </p>
            ...
            <div class="flex items-center justify-center flex-col gap-8 lg:gap-0 sm:flex-row sm:justify-between">
                ...
                <div class="flex  space-x-6 sm:justify-center ">
                    <a href="javascript:;"  class="group flex justify-center items-center ">
                            <svg class="text-gray-700 group-hover:text-indigo-600" width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <g id="Social Media">
                    ...
                    <a href="javascript:;"  class="group flex justify-center items-center ">
                        <svg class="w-[1.25rem] h-[1.125rem] text-gray-700 group-hover:text-indigo-600" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="javascript:;"  class="group flex justify-center items-center ">
                        <svg class="w-[1rem] h-[1rem] text-gray-700 group-hover:text-indigo-600" viewBox="0 0 13 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="javascript:;"  class="group flex justify-center items-center ">
                        <svg class="w-[1.25rem] h-[0.875rem] text-gray-700 group-hover:text-indigo-600" viewBox="0 0 16 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M13.9346 1.13529C14.5684 1.30645 15.0665 1.80588 15.2349 2.43896C15.5413 3.58788 15.5413 5.98654 15.5413 5.98654C15.5413 5.98654 15.5413 8.3852 15.2349 9.53412C15.0642 10.1695 14.5661 10.669 13.9346 10.8378C12.7886 11.1449 8.19058 11.1449 8.19058 11.1449C8.19058 11.1449 3.59491 11.1449 2.44657 10.8378C1.81277 10.6666 1.31461 10.1672 1.14622 9.53412C0.839844 8.3852 0.839844 5.98654 0.839844 5.98654C0.839844 5.98654 0.839844 3.58788 1.14622 2.43896C1.31695 1.80353 1.81511 1.30411 2.44657 1.13529C3.59491 0.828125 8.19058 0.828125 8.19058 0.828125C8.19058 0.828125 12.7886 0.828125 13.9346 1.13529ZM10.541 5.98654L6.72178 8.19762V3.77545L10.541 5.98654Z" fill="currentColor"></path>
                            </svg>
